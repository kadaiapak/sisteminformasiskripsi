...
// surat izin observasi penelitian
    ...
    // bisa di akses oleh admin departemen dan kepala departemen untuk melihat semua pengajuan surat yang sudah selesai
    $routes->get('/izin-observasi-penelitian/selesai', 'IzinObservasiPenelitian::selesai', ['filter' => 'adminDepartemenDanKadepFilter']);
    
    // routes untuk detail
    $routes->get('/izin-observasi-penelitian/detail/(:any)', 'IzinObservasiPenelitian::detail/$1', ['filter' => 'mahasiswaDanAdminDepartemenFilter']);
    // routes untuk edit
...
// ROUTES UNTUK IZIN PENELITIAN
    ...
    // routes untuk scan barcode
    $routes->get('/izin-penelitian/detail/(:any)', 'IzinPenelitian::detail/$1', ['filter' => 'mahasiswaDanAdminDepartemenFilter']);
    // bisa di akses oleh mahasiswa untuk menampilkan detail pengajuan surat izin observasi matakuliah yang akan di edit
    ...
    // bisa di akses oleh mahasiswa untuk membuat surat validator instrumen
    $routes->get('/izin-penelitian/selesai', 'IzinPenelitian::selesai', ['filter' => 'adminDepartemenDanKadepFilter']);
