                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9" >
                                    <textarea class="form-control" rows="5" cols="100%" name="jabatan_penanda_tangan" id="jabatan_penanda_tangan" placeholder="Tuliskan jabatan yang menandatangani surat"><?= $departemen_by_id['jabatan_penanda_tangan']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3" for="nama_penanda_tangan">Nama Penanda Tangan</label>
                                <div class="col-md-9 col-sm-9" >
                                    <textarea class="form-control" rows="5" cols="100%" name="nama_penanda_tangan" id="nama_penanda_tangan" placeholder="Tuliskan nama pimpinan yang menandatangani surat"><?= $departemen_by_id['nama_penanda_tangan']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row ">
