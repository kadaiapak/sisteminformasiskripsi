                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php if (session()->get('username')) { ?>
                            <a href="<?= base_url("izin-observasi-matakuliah/semua"); ?>" class="btn btn-warning btn-sm"><i class="fa fa-arrow-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                        <?php } ?>
                        ...
                        <?php if(session()->get('level') == '4' && $satu_observasi['status'] == '3') { ?>
                                ...
                                <form action="<?= base_url('izin-observasi-matakuliah/setujui-kadep/'.$satu_observasi['uuid']); ?>" method="post" id="setujui_kadep">
                                    <?= csrf_field(); ?>
...
<div class="modal fade terima_pengajuan_admin" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm" style="max-width: 500px;">
        <form action="<?= base_url('izin-observasi-matakuliah/setujui-admin/'.$satu_observasi['uuid']); ?>" method="post" id="setujui_admin">
            <?= csrf_field(); ?>
...
<div class="modal fade tolak_pengajuan_kadep" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm" style="max-width: 500px;">
        <form action="<?= base_url('izin-observasi-matakuliah/tolak-kadep/'.$satu_observasi['uuid']); ?>" method="post" id="tolak_kadep">
            <?= csrf_field(); ?>
            <div class="modal-content">
                <div class="modal-body">
                    <div class="form-group row">
...
<div class="modal fade tolak_pengajuan_admin" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm" style="max-width: 500px;">
        <form action="<?= base_url('izin-observasi-matakuliah/tolak-admin/'.$satu_observasi['uuid']); ?>" method="post" id="tolak_admin">
            <?= csrf_field(); ?>
            <div class="modal-content">
                <div class="modal-body">
                    <div class="form-group row">
