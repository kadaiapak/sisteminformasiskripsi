                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-striped table-bordered mb-0">
                            ...
                            <tr>
                                ...
                                <td><a href="<?= base_url("izin-observasi-matakuliah/admin-edit-pengajuan/".$satu_observasi['uuid']); ?>" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o" style="margin-right: 5px;"></i>Edit Pengajuan</a>
                            </td>
                            </tr>
                        </table>
                        <br>
                        ...
                        <?php if (session()->get('username')) { ?>
                            <a href="<?= base_url("izin-observasi-matakuliah/semua"); ?>" class="btn btn-primary btn-sm"><i class="fa fa-arrow-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
<div class="modal fade bs-example-modal-lg_<?= $a['anggota_observasi_matakuliah_id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url("izin-observasi-matakuliah/admin-simpan-pembaruan-anggota"); ?>" method="POST">
            <?= csrf_field(); ?>
