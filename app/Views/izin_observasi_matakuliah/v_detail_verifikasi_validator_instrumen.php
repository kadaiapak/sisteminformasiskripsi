                        ...
                        <?php if(session()->get('level') == '7' && $satu_instrumen['status'] == '1') { ?>
                            ...
                            <div class="modal fade terima_pengajuan_admin" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-sm" style="max-width: 500px;">
                                    <form action="<?= base_url('validator-instrumen/setujui-admin/'.$satu_instrumen['uuid']); ?>" method="post" id="setujui_admin">
                                        <?= csrf_field(); ?>
                            ...
                            <div class="modal fade tolak_pengajuan_admin" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-sm" style="max-width: 500px;">
                                    <form action="<?= base_url('validator-instrumen/tolak-admin/'.$satu_instrumen['uuid']); ?>" method="post" id="tolak_admin">
                                        <?= csrf_field(); ?>
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="form-group row">
                        ...
                        <?php if(session()->get('level') == '4' && $satu_instrumen['status'] == '3') { ?>
                            ...
                            <!-- Tolak pengajuan jika status pengajuan belum di proses kadep verifikator adalah kadep-->
                                ...
                                <div class="modal fade tolak_pengajuan_kadep" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-sm" style="max-width: 500px;">
                                        <form action="<?= base_url('validator-instrumen/tolak-kadep/'.$satu_instrumen['uuid']); ?>" method="post" id="tolak_kadep">
                                            <?= csrf_field(); ?>
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="form-group row">
