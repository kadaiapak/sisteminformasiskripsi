                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-striped table-bordered mb-0">
                            ...
                            <tr>
                                ...
                                <td><?= $satu_observasi['d_pembimbing_peg_gel_dep']; ?> <?= $satu_observasi['d_pembimbing_peg_nama']; ?> <?= $satu_observasi['d_pembimbing_peg_gel_bel']; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><a href="<?= base_url("izin-observasi-matakuliah-fakultas/admin-edit-pengajuan/".$satu_observasi['uuid']); ?>" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o" style="margin-right: 5px;"></i>Edit Pengajuan</a>
                            </td>
                            </tr>
                        </table>
                        <br>
                                ...
                                <?php foreach ($anggota as $a) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--  -->
                                            <form class="d-inline" method="post" action="<?= base_url('/izin-observasi-matakuliah-fakultas/hapus-anggota/'.$a['anggota_observasi_matakuliah_id']); ?>">
                                                <?= csrf_field(); ?>
                        ...
                        <?php if (session()->get('username')) { ?>
                            <a href="<?= base_url("izin-observasi-matakuliah-fakultas/semua"); ?>" class="btn btn-primary btn-sm"><i class="fa fa-arrow-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
<div class="modal fade bs-example-modal-lg_<?= $a['anggota_observasi_matakuliah_id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url("izin-observasi-matakuliah-fakultas/admin-simpan-pembaruan-anggota"); ?>" method="POST">
            <?= csrf_field(); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="Simpan" class="btn btn-success"><i class="fa fa-save" style="margin-right: 5px;"></i>Simpan</button>
            </div>
            </form>
        </div>
    </div>
