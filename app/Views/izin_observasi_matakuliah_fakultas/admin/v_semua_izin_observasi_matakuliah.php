                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if(session()->get('level') == '1' || session()->get('level') == '2') { ?>
                                                        ...
                                                        <a href="<?= base_url('izin-observasi-matakuliah-fakultas/edit-admin/'.$siomk['uuid']); ?>" class="btn btn-warning btn-sm" ><i class="fa fa-edit" style="margin-right: 5px;"></i>Edit</a>
                                                        <a href="<?= base_url('izin-observasi-matakuliah-fakultas/detail-verifikasi/'.$siomk['uuid']); ?>" class="btn btn-primary btn-sm" ><i class="fa fa-check-square-o" style="margin-right: 5px;"></i>Verifikasi</a>
                                                        <!-- end -->
                                                    <?php } ?>
                                                </td>
                                            <?php $no++ ?>
