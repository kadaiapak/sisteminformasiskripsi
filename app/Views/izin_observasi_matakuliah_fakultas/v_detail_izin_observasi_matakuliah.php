    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Izin Observasi Matakuliahs</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php if (session()->get('username')) { ?>
                            ...
                            <a href="<?= base_url("izin-observasi-matakuliah-fakultas/selesai"); ?>" class="btn btn-warning btn-sm"><i class="fa fa-arrow-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                            <?php }else { ?>
                                <a href="<?= base_url("izin-observasi-matakuliah-fakultas"); ?>" class="btn btn-warning btn-sm"><i class="fa fa-arrow-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                            <?php } ?>
                        <?php } ?>
                    </div>
                </div>
