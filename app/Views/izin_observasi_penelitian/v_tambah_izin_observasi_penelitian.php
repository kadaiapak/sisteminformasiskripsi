                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('izin-observasi-penelitian/simpan'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" value="" class="form-control <?= validation_show_error('tujuan_surat') ? 'is-invalid' : null; ?>" id="tujuan_surat" name="tujuan_surat" placeholder="Contoh: Kepala Sekolah SMA N 5 Solok Selatan">
                                    <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" value="" class="form-control <?= validation_show_error('alamat_surat') ? 'is-invalid' : null; ?>" id="alamat_surat" name="alamat_surat" placeholder="Contoh: Solok Selatan">
                                    <div class="invalid-feedback" style="display: block;">
