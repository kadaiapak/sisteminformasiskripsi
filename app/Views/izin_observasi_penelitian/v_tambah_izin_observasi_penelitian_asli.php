                        ...
                        <?= csrf_field(); ?>
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input readonly type="text" value="<?= $user['prf_nim_portal']; ?>" name="nim_pengajuan" class="form-control <?= validation_show_error('nim_pengajuan') ? 'is-invalid' : null; ?>" id="nim_pengajuan" placeholder="Tuliskan NIM">
                            ...
                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3" for="tujuan_surat">Kepada: Yth,.</label>
                                <div class="col-md-9 col-sm-9 ">
