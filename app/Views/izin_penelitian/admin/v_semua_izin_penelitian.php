                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php $no = 1 ?>
                                        <?php foreach($semua_izin_penelitian as $siomk): ?>
                                            <tr>
                                                <td><?= $no; ?></td>
                                                ...
                                                <td>
                                                    <?php if(session()->get('level') == '7' || session()->get('level') == '4') { ?>
                                                        ...
                                                        <a href="<?= base_url('izin-penelitian/detail-verifikasi/'.$siomk['uuid']); ?>" class="btn btn-primary btn-sm" ><i class="fa fa-check-square-o" style="margin-right: 5px;"></i>Verif</a>
                                                        <!-- end -->
                                                    <?php } ?>
                                                    <?php if(session()->get('level') == '7') { ?>
                                                        <!-- jika level adalah admin departemen atau kadep maka url nya -->
                                                        <a href="<?= base_url('izin-penelitian/edit-admin/'.$siomk['uuid']); ?>" class="btn btn-warning btn-sm" ><i class="fa fa-check-square-o" style="margin-right: 5px;"></i>Edit</a>
                                                        <!-- end -->
                                                    <?php } ?>
                                                </td>
                                            <?php $no++ ?>
