                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?= csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3" for="judul">Judul Penelitian</b></label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input required type="text" value="" class="form-control <?= validation_show_error('judul') ? 'is-invalid' : null; ?>" id="judul" name="judul" placeholder="Judul penelitian">
                                    <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3" for="alamat_tempat_penelitian">Alamat Tempat Penelitian</b></label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input required type="text" value="" class="form-control <?= validation_show_error('alamat_tempat_penelitian') ? 'is-invalid' : null; ?>" id="alamat_tempat_penelitian" name="alamat_tempat_penelitian" placeholder="Tuliskan alamat tempat">
                                    <div class="invalid-feedback" style="display: block;">
