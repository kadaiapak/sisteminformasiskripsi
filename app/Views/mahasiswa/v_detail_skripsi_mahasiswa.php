                                                                    ...
                                                                    <table class="table table-striped table-bordered" style="width:100%">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="<?= base_url('mahasiswa/detail-seminar/'.$ssr['smr_uuid'].'/'.$ssr['smr_id']); ?>" class="btn btn-primary"><i class="fa fa-file-text-o" style="margin-right: 5px;"></i>Detail</a>
                                                                    ...
                                                                    <table class="table table-striped table-bordered" style="width:100%">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="<?= base_url('/mahasiswa/detail-ujian-skripsi/'.$su['us_uuid']); ?>" class="btn btn-primary btn-sm" style="font-size: 10px;"><i class="fa fa-file-text-o" style="margin-right: 5px;"></i>Detail</a>
