...
<style>
    .select2-container {
    width: 100% !important; /* Mengatur lebar menjadi 100% dari elemen induk */
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="button_container">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".ganti_ruangan"><i class="fa fa-check-square" style="margin-right: 5px;"></i>Ganti Jadwal</button>
                        </div>
                        <div class="modal fade ganti_ruangan" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-sm" style="max-width: 500px;">
                                <form action="<?= base_url('seminar/'.$satu_seminar->smr_uuid.'/rubah_jadwal_oleh_admin'); ?>" method="post" id="tolak_admin">
                                    <?= csrf_field(); ?>
                                    <input type="hidden" name="idSeminar" value="<?= $satu_seminar->smr_id; ?>">
                                    <input type="hidden" name="nim" value="<?= $satu_seminar->smr_nim_m; ?>"> 
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Rubah Jadwal Seminar</h5>
            ...
            $('#smr_ganti_tanggal').on('change', function() {
                ...
                if (tanggal) {
                    ...
                    $('#smr_ruangan').select2({
                        ...
                        ajax: {
                            url: '<?= site_url('seminar/getRuanganBisaDipakai') ?>', // URL untuk mengambil produk
                            dataType: 'json',
                            delay: 250,
