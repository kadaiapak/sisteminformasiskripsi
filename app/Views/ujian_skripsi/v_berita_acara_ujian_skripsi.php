            ...
            <?php endif; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="x_panel" style="display: flex;">
                        <a href="<?= base_url('ujian-skripsi/pembimbing'); ?>" class="btn btn-sm btn-warning"><i class="fa fa-chevron-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                        <form action="<?= base_url('ujian-skripsi/simpan-berita-acara'); ?>" method="POST">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="nilai_p" value="<?= $semua_nilai[0]['nilai_akhir']; ?>">
                            <input type="hidden" name="nilai_p_satu" value="<?= $semua_nilai[1]['nilai_akhir']; ?>">
                            <input type="hidden" name="nilai_p_dua" value="<?= $semua_nilai[2]['nilai_akhir']; ?>">
                            <input type="hidden" name="rata_rata_angka" value="<?= $rata; ?>">
                            <input type="hidden" name="rata_rata_huruf" value="<?= $round_rata_huruf; ?>">
                            <input type="hidden" name="us_uuid" value="<?= $satu_ujian['us_uuid']; ?>">
                            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-save" style="margin-right: 5px;"></i>Simpan Berita Acara</button>
                        </form>
                    </div>
                </div>
        </div>
