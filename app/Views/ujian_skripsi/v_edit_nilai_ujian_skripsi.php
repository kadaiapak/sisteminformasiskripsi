...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="row">
            ...
            <form action="<?= base_url('ujian-skripsi/'.$satu_ujian['us_uuid'].'/simpan-edit'); ?>" method="post">
                <?= csrf_field(); ?>
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" value="<?= $satu_nilai['perumusan_masalah']; ?>" name="perumusan_masalah" id="perumusan_masalah"  class="form-control <?= validation_show_error('perumusan_masalah') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('perumusan_masalah'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" name="perumusan_masalah_bobot" id="perumusan_masalah_bobot" value="<?= $satu_nilai['perumusan_masalah_bobot']; ?>" class="form-control <?= validation_show_error('perumusan_masalah_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('perumusan_masalah_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" class="form-control" value="<?= $satu_nilai['perumusan_masalah_total']; ?>" name="perumusan_masalah_total" id="perumusan_masalah_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" name="tinjauan_pustaka" value="<?= $satu_nilai['tinjauan_pustaka']; ?>" id="tinjauan_pustaka" class="form-control <?= validation_show_error('tinjauan_pustaka') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('tinjauan_pustaka'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number"  value="<?= $satu_nilai['tinjauan_pustaka_bobot']; ?>"  name="tinjauan_pustaka_bobot" id="tinjauan_pustaka_bobot" class="form-control <?= validation_show_error('tinjauan_pustaka_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('tinjauan_pustaka_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['tinjauan_pustaka_total']; ?>"  class="form-control" name="tinjauan_pustaka_total" id="tinjauan_pustaka_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" value="<?= $satu_nilai['pengumpulan_data']; ?>"  name="pengumpulan_data" id="pengumpulan_data" class="form-control <?= validation_show_error('pengumpulan_data') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('pengumpulan_data'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['pengumpulan_data_bobot']; ?>"  name="pengumpulan_data_bobot" id="pengumpulan_data_bobot" class="form-control <?= validation_show_error('pengumpulan_data_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('pengumpulan_data_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly value="<?= $satu_nilai['pengumpulan_data_total']; ?>"  type="number"class="form-control" name="pengumpulan_data_total" id="pengumpulan_data_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-lg-6 col-md-6 col-sm-6" for="kesesuaian_desain">Kesesuaian Desain</label>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" value="<?= $satu_nilai['kesesuaian_desain']; ?>"  name="kesesuaian_desain" id="kesesuaian_desain" class="form-control <?= validation_show_error('kesesuaian_desain') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('kesesuaian_desain'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['kesesuaian_desain_bobot']; ?>" name="kesesuaian_desain_bobot" id="kesesuaian_desain_bobot" class="form-control <?= validation_show_error('kesesuaian_desain_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('kesesuaian_desain_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['kesesuaian_desain_total']; ?>" class="form-control" name="kesesuaian_desain_total" id="kesesuaian_desain_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-lg-6 col-md-6 col-sm-6" for="kerangka_konseptual">Kerangka Konseptual</label>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" id="kerangka_konseptual" value="<?= $satu_nilai['kerangka_konseptual']; ?>" name="kerangka_konseptual"  id="kerangka_konseptual" class="form-control <?= validation_show_error('kerangka_konseptual') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('kerangka_konseptual'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['kerangka_konseptual_bobot']; ?>" name="kerangka_konseptual_bobot" id="kerangka_konseptual_bobot" class="form-control <?= validation_show_error('kerangka_konseptual_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('kerangka_konseptual_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" class="form-control" value="<?= $satu_nilai['kerangka_konseptual_total']; ?>" name="kerangka_konseptual_total" id="kerangka_konseptual_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-lg-6 col-md-6 col-sm-6" for="logika_penulisan">Logika Penulisan dan Bahasa</label>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" name="logika_penulisan" value="<?= $satu_nilai['logika_penulisan']; ?>" id="logika_penulisan" class="form-control <?= validation_show_error('logika_penulisan') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('logika_penulisan'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['logika_penulisan_bobot']; ?>" name="logika_penulisan_bobot" id="logika_penulisan_bobot" class="form-control <?= validation_show_error('logika_penulisan_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('logika_penulisan_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['logika_penulisan_total']; ?>" class="form-control" name="logika_penulisan_total" id="logika_penulisan_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-lg-6 col-md-6 col-sm-6" for="orisinalitas">Orisinalitas</label>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" name="orisinalitas" value="<?= $satu_nilai['orisinalitas']; ?>" id="orisinalitas" class="form-control <?= validation_show_error('orisinalitas') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('orisinalitas'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['orisinalitas_bobot']; ?>" name="orisinalitas_bobot" id="orisinalitas_bobot" class="form-control <?= validation_show_error('orisinalitas_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('orisinalitas_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['orisinalitas_total']; ?>" class="form-control" name="orisinalitas_total" id="orisinalitas_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-lg-6 col-md-6 col-sm-6" for="kesimpulan_dan_saran">Kesimpulan dan Saran</label>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" name="kesimpulan_dan_saran" value="<?= $satu_nilai['kesimpulan_dan_saran']; ?>" id="kesimpulan_dan_saran" class="form-control <?= validation_show_error('kesimpulan_dan_saran') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('kesimpulan_dan_saran '); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['kesimpulan_dan_saran_bobot']; ?>"  name="kesimpulan_dan_saran_bobot" id="kesimpulan_dan_saran_bobot" class="form-control <?= validation_show_error('kesimpulan_dan_saran_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('kesimpulan_dan_saran _bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" class="form-control" value="<?= $satu_nilai['kesimpulan_dan_saran_total']; ?>" name="kesimpulan_dan_saran_total" id="kesimpulan_dan_saran_total">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" name="penyajian" value="<?= $satu_nilai['penyajian']; ?>" id="penyajian" class="form-control <?= validation_show_error('penyajian') ? 'is-invalid' : null; ?>" >
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('penyajian'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['penyajian_bobot']; ?>" name="penyajian_bobot" id="penyajian_bobot" class="form-control <?= validation_show_error('penyajian_bobot') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('penyajian _bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['penyajian_total']; ?>" class="form-control" name="penyajian_total" id="penyajian_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-lg-6 col-md-6 col-sm-6" for="mempertahankan_skripsi">Kemampuan Mempertahankan Skripsi</label>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="number" value="<?= $satu_nilai['mempertahankan_skripsi']; ?>" name="mempertahankan_skripsi" id="mempertahankan_skripsi" class="form-control <?= validation_show_error('mempertahankan_skripsi') ? 'is-invalid' : null; ?>">
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('mempertahankan_skripsi'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['mempertahankan_skripsi_bobot']; ?>" id="mempertahankan_skripsi_bobot" name="mempertahankan_skripsi_bobot" class="form-control <?= validation_show_error('mempertahankan_skripsi_bobot') ? 'is-invalid' : null; ?>" >
                                    <div class="invalid-feedback" style="text-align: left;">
                                        <?= validation_show_error('mempertahankan_skripsi_bobot'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['mempertahankan_skripsi_total']; ?>" class="form-control" id="mempertahankan_skripsi_total" name="mempertahankan_skripsi_total">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" value="<?= $satu_nilai['jumlah']; ?>" class="form-control" name="jumlah_total" id="jumlah_total">
                                </div>
                            </div>
                            <div class="form-group row" style="border-top: 2px solid #E6E9ED; padding-top: 20px;">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input readonly type="number" class="form-control" value="<?= $satu_nilai['nilai_akhir']; ?>" name="nilai_akhir" id="nilai_akhir">
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    $(document).ready(function() {
        ...
        $('input[type="number"]').change(function() {
            ...
            var perumusan_masalah_total_tampil = perumusan_masalah_total.toFixed(2);
            ...
            var tinjauan_pustaka_total_tampil = tinjauan_pustaka_total.toFixed(2);
            ...
            var pengumpulan_data_total_tampil = pengumpulan_data_total.toFixed(2);
            ...
            var kesesuaian_desain_total_tampil = kesesuaian_desain_total.toFixed(2);
            ...
            var kerangka_konseptual_total_tampil = kerangka_konseptual_total.toFixed(2);
            ...
            var logika_penulisan_total_tampil = logika_penulisan_total.toFixed(2);
            ...
            var orisinalitas_total_tampil = orisinalitas_total.toFixed(2);
            ...
            var kesimpulan_dan_saran_total_tampil = kesimpulan_dan_saran_total.toFixed(2);
            ...
            var penyajian_total_tampil = penyajian_total.toFixed(2);
            ...
            var mempertahankan_skripsi_total_tampil = mempertahankan_skripsi_total.toFixed(2);
            $('#perumusan_masalah_total').val(perumusan_masalah_total_tampil);
            $('#tinjauan_pustaka_total').val(tinjauan_pustaka_total_tampil);
            $('#pengumpulan_data_total').val(pengumpulan_data_total_tampil);
            $('#kesesuaian_desain_total').val(kesesuaian_desain_total_tampil);

            $('#kerangka_konseptual_total').val(kerangka_konseptual_total_tampil);
            $('#logika_penulisan_total').val(logika_penulisan_total_tampil);
            $('#orisinalitas_total').val(orisinalitas_total_tampil);
            $('#kesimpulan_dan_saran_total').val(kesimpulan_dan_saran_total_tampil);
            $('#penyajian_total').val(penyajian_total_tampil);
            $('#mempertahankan_skripsi_total').val(mempertahankan_skripsi_total_tampil);
            ...
            var jumlah_total_tampil = jumlah_total.toFixed(2);
            $('#jumlah').val(jumlah_nilai);
            $('#jumlah_bobot').val(jumlah_bobot);
            $('#jumlah_total').val(jumlah_total_tampil);
