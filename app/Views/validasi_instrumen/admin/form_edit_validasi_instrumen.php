                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input required type="text" value="<?= $satu_penelitian['tujuan_surat']; ?>" class="form-control <?= validation_show_error('tujuan_surat') ? 'is-invalid' : null; ?>" id="tujuan_surat" name="tujuan_surat" placeholder="Contoh: Kepala Sekolah SMA N 5 Solok Selatan">
                                    <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input required type="text" value="<?= $satu_penelitian['alamat_tujuan_surat']; ?>" class="form-control <?= validation_show_error('alamat_tujuan_surat') ? 'is-invalid' : null; ?>" id="alamat_tujuan_surat" name="alamat_tujuan_surat" placeholder="Contoh: Solok Selatan">
                                    <div class="invalid-feedback" style="display: block;">
