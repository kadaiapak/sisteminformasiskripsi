                    ...
                    <div class="x_content">
                        ...
                        <?= csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input required type="text" value="" class="form-control <?= validation_show_error('alamat_tujuan_surat') ? 'is-invalid' : null; ?>" id="alamat_tujuan_surat" name="alamat_tujuan_surat" placeholder="Di ?">
                                    <div class="invalid-feedback" style="display: block;">
